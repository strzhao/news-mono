    ...
    commands: [
      {
        ...
        options: [
          { name: "date", short: "d", description: "Target date (YYYY-MM-DD)", required: false, type: "string" },
          { name: "tz", description: "Timezone (default: Asia/Shanghai)", required: false, type: "string" },
          { name: "skip_jitter", description: "Skip random jitter delay", required: false, type: "boolean" },
        ],
      },
      {
        path: ["extract", "url"],
        ...
        options: [
          { name: "url", short: "u", description: "URL to extract", required: true, type: "string" },
          { name: "blob_ttl_hours", description: "Blob TTL in hours (1-168)", required: false, type: "number" },
        ],
      },
      {
        path: ["extract", "status"],
      ...
      },
      {
        ...
        options: [
          { name: "limit", short: "l", description: "Max results", required: false, type: "number" },
        ],
      },
      {
        path: ["articles", "list"],
        ...
        options: [
          { name: "date", short: "d", description: "Date (YYYY-MM-DD, default: today)", required: false, type: "string" },
          { name: "limit", short: "l", description: "Max results (1-200, default: 50)", required: false, type: "number" },
          { name: "offset", description: "Offset for pagination", required: false, type: "number" },
          { name: "quality_tier", description: "Quality tier: high|general|all", required: false, type: "string" },
          { name: "source_channel", description: "Filter by source channel", required: false, type: "string" },
          { name: "tag_group", description: "Filter by tag group", required: false, type: "string" },
      ...
      },
      {
        ...
        options: [
          ...
          { name: "quality_tier", description: "Quality tier: high|general|all", required: false, type: "string" },
          { name: "source_channel", description: "Filter by source channel", required: false, type: "string" },
          { name: "source_id", description: "Filter by source ID", required: false, type: "string" },
          { name: "q", description: "Search query", required: false, type: "string" },
          { name: "limit", short: "l", description: "Max results (1-200)", required: false, type: "number" },
          { name: "offset", description: "Offset for pagination", required: false, type: "number" },
        ],
      },
      {
